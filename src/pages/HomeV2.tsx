...
function useScrambleBuild(text: string) {
  ...
  useEffect(() => {
    ...
    const ANNOUNCE_DELAY = 400;  // tag appears first — user reads "xenny."
...
function LayerDiagram({ lang }: { lang: "en" | "es" }) {
  const labels = {
    en: {
      ...
      mid: { title: "XENNY EXECUTION LAYER", sub: "Sales Ops · Content · Data · Ops" },
    ...
    es: {
      ...
      mid: { title: "CAPA DE EJECUCIÓN XENNY", sub: "Sales Ops · Contenido · Data · Ops" },
  ...
  return (
    <div className="v2-layer-diagram">
      ...
      <div className="v2-layer-box v2-layer-box--xenny">
...
const copy = {
  en: {
    ...
    heroSub:
      "Xenny gives lean B2B teams an AI execution layer for sales ops, content, and growth workflows — so they can run more pipeline, follow up faster, and ship more without hiring headcount too early.",
    heroCta: "Book a demo",
    ...
    whatKicker: "What Xenny actually is",
    ...
    whatP2:
      "Xenny deploys specialized AI teams that work as one unit inside your operation. They do the repetitive work, keep workflows moving, and expand your execution capacity without adding unnecessary friction.",

    whoKicker: "Built for lean B2B teams",
    whoTitle:
      "Xenny is for companies that already have traction, but whose team is still too small for the operational load.",
    whoItems: [
    ...
    promiseKicker: "What changes with Xenny",
    promiseTitle: "With Xenny, the team stays lean — but the operation does not.",
    promiseItems: [
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Xenny activates specialized agents across sales ops, content, and repetitive operational work.",
      },
      {
        n: "03",
    ...
    whyP2:
      "Xenny helps you add capacity before operational chaos forces a larger headcount decision.",
  ...
  es: {
    ...
    heroSub:
      "Xenny le da a equipos B2B pequeños una capa de ejecución con IA para sales ops, contenido y crecimiento — para mover más pipeline, responder más rápido y producir más, sin contratar gente antes de tiempo.",
    ...
    whatKicker: "Qué es Xenny en realidad",
    ...
    whatP2:
      "Xenny despliega equipos de IA especializados que trabajan como una sola unidad dentro de tu operación. Se encargan del trabajo repetitivo, mantienen los flujos en movimiento y amplían tu capacidad sin agregar fricción.",

    whoKicker: "Para equipos B2B que ya tienen tracción",
    whoTitle:
      "Xenny es para empresas que ya están creciendo, pero cuyo equipo todavía es demasiado chico para la carga operativa.",
    whoItems: [
    ...
    promiseKicker: "Qué cambia con Xenny",
    promiseTitle: "Con Xenny, el equipo sigue siendo chico — pero la operación no lo parece.",
    promiseItems: [
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Xenny pone a trabajar agentes especializados en sales ops, contenido y operación repetitiva.",
      },
      {
        n: "03",
    ...
    whyP2:
      "Xenny te ayuda a sumar capacidad antes de que el caos te fuerce a contratar más gente de la que necesitas.",
...
export default function HomeV2() {
  ...
  const demoLink = createWhatsAppUrl(
    lang === "en"
      ? "Hi Xenny, I want to book a demo for my company. I came from the homepage and want to see how your AI teams could support our operation."
      : "Hola Xenny, quiero agendar una demo para mi empresa. Vengo desde la home y quiero ver cómo sus equipos AI podrían apoyar nuestra operación."
  );
  ...
  return (
    <div className="v2-page">
      ...
      <header className={`v2-top-nav${navScrolled ? " v2-top-nav--scrolled" : ""}`}>
        <span className="v2-brand">xenny.</span>
            ...
            <h1 className="v2-title">
              ...
              <span className="v2-built-line" aria-label={t.heroTitle[1]}>
                ...
                <span className="v2-cursor-wrap" aria-hidden="true">
                  {tagVisible && (
                    <span className={`v2-xenny-tag${tagFading ? " v2-xenny-tag--fade" : ""}`}>
                      <span className={`v2-xenny-tag-dot${buildState === "building" ? " v2-xenny-tag-dot--active" : ""}`} />
                      xenny.
                    </span>
                  )}
                  <span
        ...
        >
          <div className="v2-contact-modal" role="dialog" aria-modal="true" aria-labelledby="v2-contact-modal-title">
            ...
            <div className="v2-contact-modal-actions">
              ...
              <a href="mailto:contact@xenny.xyz" className="v2-contact-option v2-contact-option--mail">
                <span>{modalCopy.classic}</span>
                <strong>{modalCopy.classicCta}</strong>
              </a>
            </div>
            <p className="v2-contact-email">
              {modalCopy.emailLabel} <a href="mailto:contact@xenny.xyz">contact@xenny.xyz</a>
            </p>
          </div>
        </div>
      )}
